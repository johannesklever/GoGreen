...
Public Class GoogleMapHelper
    ...
    Private Const ICON_FOLDER As String = "Icons/baseline_place_black_18dp" 'images must be stored in a folder inside  Debug/Release folder
    Private Const MAP_TEMPLATE As String = "GoGreen.googlemap_template.html"
